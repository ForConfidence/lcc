...
Edo.build(
		{
			...
			children:[
                     {type: 'ct',width: '100%',height: '100%',padding:[0,0,0,0],
                    				border:[0,0,0,0],
                      children:[
                               {id: 'leftPanel',type: 'panel',title: '数据列表',width: '100%',height: '100%',padding:[0,0,0,0],
                                ...
                                children: [
										    ...
										    children: [
										        ...
										        },
										        {
										            ...
										            onclick: function(e){
										            	var r = moduletree.getSelected();
										                if(r){
										                	parent.openNewTab2({id: 'datacomment', url: '', name: '评价计算数据'},{})
												            //window.open('js/lcc/qiche/qiche1_1.jsp?moduleid='+r.moduleid)
										                }else{
										                    alert("请选择模板");
										                }
                                       	...
                                       	},
                                        {
									        ...
									        columns:[
						                     ...
						                     data:[{name:'汽轮机',module:'',useamount:'',person:'',
						                    	 children:[{name:'数据集1',module:'汽轮机模板1',useamount:30,person:'王涛',children:[]},
						                         ...
						                         ]}, {name:'冰箱',module:'',useamount:'',person:'',children:[ {name:'数据集3',module:'汽轮机模板1',useamount:20,person:'黄易',children:[]}]}]
						           ...
						           /* {type:'box',width: '100%',padding:[5,0,0,5],verticalGap:'10',
						            ...
						            },*/
						            {
									    ...
									    children:[
								          {	type : 'formitem',label : '数据集名称:',labelWidth : 100,labelAlign : 'center',
								       	    children : [{type : 'label',width : 200,id : 'datasetname',text:'数据集1'}]
								       	},
								       	{type : 'formitem',label : '所属模板名称:',labelWidth : 100,labelAlign : 'center',
								  ...
								  },
								  {
								  	    ...
								  	    children:[
										{type : 'formitem',label : '所属零部件:',labelWidth : 100,labelAlign : 'center',
											children : [{type : 'label',width : 200,id : 'version',text:'汽轮机'}]
											},
								      ...
								      },
								  {
										...
										{type : 'formitem',label : '构建人:',labelWidth : 100,labelAlign : 'center',
											children : [{type : 'label',width : 200,id : 'creatername',text:'王涛'},{type : 'text',visible:false,width : 150,id : 'createrid'}]
											},
