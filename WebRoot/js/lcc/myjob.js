		    ...
		    children: [
	        	...
	        	{type: 'button', text: '执行任务',width:100,
		        	onclick: function(e){
		        		var r = Edo.get("myjob").getSelected();
			        	taskid=r.id;
		        		window.open('lcc/indexpage!lcataskcommitCT.action?taskid='+taskid);}}
		    ]
			} ,      
           {
			id: 'myjob', 
		    ...
		    columns:[{	    	
	            ...
	            {header:'创建时间',dataIndex: 'starttime',headerAlign: 'center',align: 'center',width: 200,height:80,
	        	},
	            ...
	            {header:'完成度',dataIndex: 'finish', headerAlign: 'center',align: 'center',width: 150,height:80,renderer: function(v, r, c, i, data, t){
	                return '0%';}},
		    ],
...
function search(){ 
	//alert('ss')
	    ...
	    var data = cims201.utils.getData("lcc/task!getMytasks.action",{index:index+1,size:size});
									        ...
									        {	type : 'formitem',label : '要求结束时间:',labelWidth : 100,labelAlign : 'center',
							             	...
							             	{type:'button',text:'执行项目',onclick: function(e){
							               	...
							               	{type:'button',text:'分配任务',onclick: function(e){
		    	                              		...
		    	                              		Edo.get('modulebuilder').set('src',basePath+'js/lcc/taskassignment.jsp?taskid='+taskid);
		    	                              	}}
	    	                  	    	              ]
    	                              }
