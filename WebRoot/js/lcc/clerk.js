...
var url=basePath+'department/department!getEmployee.action';
var param={};
var id='emp';
...
function getNewEmployeeWin(){
	var func=function(id){
		...
		var data= cims201.utils.getData(basePath+'department/department!saveEmployee.action',{employee:employee});
		var url=basePath+'department/department!getEmployee.action';
		var param={};
		var id='emp';
		refreshdata(employdataTable,url,param,id);
