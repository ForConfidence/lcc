...
function createnewmodule(){
	var flowmodule= Edo.create({
		...
		width: '100%',
		height:'100%',
		src:'lcc/welcome!getdraw.action'
	});
...
function showmodule(){
	var data= cims201.utils.getData('lcc/welcome!getModuletree.action');
	var box=Edo.build({
	    type: 'box',
	    width: '100%',
		height:'100%',
	            ...
	            children: [
	                {
				        ...
				        onbodymousedown: function(e){
				        	...
				        	Edo.get('moduleview').set('src', 'lcc/welcome!getmodulelook.action?moduleid='+r.id);
