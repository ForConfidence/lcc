						    ...
						    children: [
								{
								    ...
								    onclick: function(e){
								        ...
								        var id='outputmaterial';
								        refreshdata(basedataTable,url,param,id);
								 	    var toolbar=new gettoolbar(null,func);
								  	    var win=cims201.utils.getWin(600,450,'选择输出',[content,toolbar]);
						        ...
						        /*{type: 'button',text: '下一步',width:80,height: 30,style:'margin-left:140px;',onclick: function(e){
						        	 ...
						        	 removeselected();
							       	 openNewTab(stepdata.source[3]);
							        	 ...
							        	 {type: 'button',text: '完成',width:80,height: 30,style:'margin-left:140px;',onclick: function(e){
...
function outputresourcecontent(){
	var outputresourcecontent=Edo.create(
			...
			/*            {
			        	...
			        	{type: 'panel',title:'资源列表',width: '100%',height:200,layout: 'horizontal',padding: [0,0,0,0],border:[0,0,0,0],
							children:[   
				              {
						        type: 'table',
						        id:'outputmaterial',
