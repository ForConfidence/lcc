...
var url=basePath+'department/department!getPrivilege.action';
var param={};
var id='privi';
...
function priviSelect()
{
   ...
   if(r!=null){
   var data= cims201.utils.getData(basePath+'department/department!getOwnPrivilegeOperationRoles.action',{id:r.id});
		...
		children:[	
		    ...
		    children: [
				        ...
				        {type: 'button',text: '删除',onclick: function(e){
				        	...
				        	if(r){
				        		privi.data.remove(r);
				        		var data= cims201.utils.getData(basePath+'department/department!deletePrivilege.action',{id:r.id});
			        		}else{
			        			alert("请选择部门");
		        			}}},
			            {type: 'split'}
		...
		},
	       {
	        ...
	        children:[
	        	...
	        	onclick: function(e){
					...
					if(r2&&r.length>0){
						var data= cims201.utils.getData(basePath+'department/department!deletePrivilegeOperationRoles.action',{id:r2.id,rolearray:r});
	       ...
	       },
	      {
	        ...
	        children:[
				...
				onclick: function(e){
					...
					var r2=privi.getSelected();
					if(r2&&r.length>0){
						var data= cims201.utils.getData(basePath+'department/department!addPrivilegeOperationRoles.action',{id:r2.id,rolearray:r});
					/*	for(var i=0;i<r.length;i++){
							 var r3=r[i];
...
function getNewPrivilegeWin(){
	var func=function(id){
		...
		var data= cims201.utils.getData(basePath+'department/department!savePrivilege.action',{privilege:privilege});
		var url=basePath+'department/department!getPrivilege.action';
		var param={};
		var id='privi';
		refreshdata(prividataTable,url,param,id);
