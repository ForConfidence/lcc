		...
		{type: 'box',
	    	...
	    	horizontalAlign:'center',*/
	   	    children: [
				...
				{type: 'panel',title:'输入资源信息',width: '100%',height:'100%',layout: 'vertical',border: [0,0,1,0],padding: [0,0,0,0],verticalGap:'0',
					children:[     
						{
						type: 'group',
					    width: '100%',
...
//		 				       	   	}
					...
					},
					{
						...
						children:[
							{type: 'button',text: '查看基本信息',style:'margin-left:120px;',width:80,height: 30,onclick: function(e){
								    removeselected();
									openNewTab(stepdata.source[0]);
									updatesteptabledata('stepone');
						        	}},
					        {type: 'button',text: '查看输出资源',width:80,height: 30,style:'margin-left:140px;',onclick: function(e){
					        	 removeselected();
