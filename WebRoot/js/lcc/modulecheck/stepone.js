	...
	var taskdefine = Edo.build(
	    	...
	    	//style: 'background:white;',
	   	    children: [
				...
				{type: 'panel',title:'过程基本信息',width: '100%',height:300,layout: 'vertical',border: [0,0,1,0],padding: [10,0,0,10],
					children:[
						{
       			...
       			children:[
       		        {type: 'button',text: '查看输入资源',width:80,height: 30,style:'margin-left:220px;',onclick: function(e){
	       		        removeselected();
