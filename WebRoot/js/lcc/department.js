		...
		children:[	
		    ...
		    children: [
				        ...
				        {type: 'button',id:'delebtn',text: '删除',onclick: function(e){
				        	...
				        	if(r){
				        		dep.data.remove(r);
				        		var data= cims201.utils.getData(basePath+'department/department!deleteDepartment.action',{id:r.id});
			        		}else{
			        			alert("请选择部门");
		        			}}},
			            //{type: 'split'}
...
function getNewDepartmentWin(){
	var func=function(id){
		...
		var data= cims201.utils.getData(basePath+'department/department!saveDepartment.action',{department:department});
		var url=basePath+'department/department!getDepartment.action';
		var param={};
		var id='dep';
		refreshdata(depdataTable,url,param,id);
