function buildFunctionWin(graph,cell){
	...
	var box=Edo.create(
	    ...
	    if(!cell.tasktreenode){
	    	alert('ss')
	    	var result= cims201.utils.getData('module/module!getProcessTaskTreeNode.action',{moduleid:moduleid,processid:cell.getId()
	    	});
...
var url='department/department!getDepartment.action';
var param={};
var id='dep';
...
function getcarrier(e)
{
		...
		children:[
	        ...
	        onselectionchange: function(e){	
	            var data= cims201.utils.getData('department/department!getEmployeeByDepartment.action',{id:e.selected.id});
	            emp.set("data",data)
	        },
			data:depdataTable
	       	},
