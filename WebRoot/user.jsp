...
<![endif]-->
	...
	<!-- 全生命周期评价LCA  杨文君添加 -->
	<script src="<%=basePath %>js/lcc/lca_home.js" type="text/javascript"></script>
	...
	<!-- bbl任务管理-->
	<script src="<%=basePath %>js/lcc/mytask.js" type="text/javascript"></script>
        ...
        children:[
        	...
        	{	id:'navBtns',
	            ...
	            //    },
	                ...
	                {
	                	type: 'label',height:76, style: 'padding-left:2px; padding-right:2px;padding-top:5px;', text: '<a href= "main.jsp";><div class="cims201_topbar_icon">&nbsp;<br>&nbsp;项目管理</div></a>'
	                },
	                {
