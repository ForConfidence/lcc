...
<html>
	...
	<div id="builder"
		...
		<iframe id="aa" height= 100%  width=100%  src="<%=basePath%>lcc/indexpage!modulecheckbuilder.action"></iframe>
	</div>
	...
	<div id="detaildiv"
  	...
  	<script type="text/javascript">
		...
		<script src="<%=basePath%>js/lcc/lca_modulecheck_CT.js" type="text/javascript"></script>
		<script src="<%=basePath %>js/lcc/modulecheck/stepone.js" type="text/javascript"></script>
    	<script src="<%=basePath %>js/lcc/modulecheck/steptwo.js" type="text/javascript"></script>
    	<script src="<%=basePath %>js/lcc/modulecheck/stepthree.js" type="text/javascript"></script>
    	<script src="<%=basePath %>js/lcc/lcamodulecheckcommit.js" type="text/javascript"></script>
