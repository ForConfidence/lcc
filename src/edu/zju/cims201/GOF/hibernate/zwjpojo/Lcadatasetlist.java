...
public class Lcadatasetlist implements java.io.Serializable {
	...
	private String UUID;
	private int isbase;
	private Set<Lcacalcusolution> lcacalcusolutions;
	// Constructors

	/** default constructor */
	public Lcadatasetlist() {
	}

	/** full constructor */
	public Lcadatasetlist(String datasetname, String datasetintro,
	...
	public Set<Lcacalcusolution> getLcacalcusolutions() {
		return lcacalcusolutions;
	}

	public void setLcacalcusolutions(Set<Lcacalcusolution> lcacalcusolutions) {
		this.lcacalcusolutions = lcacalcusolutions;
	}
