...
import edu.zju.cims201.GOF.dao.pdmprivilege.AdminOperationRightDao;
import edu.zju.cims201.GOF.dao.pdmprivilege.AdminPrivilegeTripleDao;
import edu.zju.cims201.GOF.dao.pdmprivilege.EmpowermentDao;
import edu.zju.cims201.GOF.dao.pdmprivilege.OperationRightDao;
import edu.zju.cims201.GOF.dao.pdmprivilege.RolePrivilegeTripleDao;
import edu.zju.cims201.GOF.dao.pdmprivilege.UserPrivilegeTripleDao;
...
public class PrivilegeServiceImpl implements PrivilegeService {
	...
	public int deletePrivilege(Empowerment empowerment, OperationRight operationRight,boolean isAdmin) {
		...
		if(!isAdmin){
			...
			int result=userPrivilegeTripleDao.batchExecute(admin_hql, empowerment,operationRight);
			userPrivilegeTripleDao.flush();
